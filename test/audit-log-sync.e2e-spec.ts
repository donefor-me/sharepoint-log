...
import { AuditLogSyncModule } from '../src/modules/audit-log-sync/audit-log-sync.module'
import { AuditLogSyncService } from '../src/modules/audit-log-sync/audit-log-sync.service'
import { AuditLogDlqStatus } from '../src/modules/audit-log-sync/constants/dlq-status.constant'
import { SYNC_CONFIG } from '../src/modules/audit-log-sync/constants/sync.constant'
...
import { SyncLockService } from '../src/modules/audit-log-sync/sync-lock.service'
import { EncryptionService } from '../src/modules/encryption/encryption.service'
import { SharepointService } from '../src/modules/sharepoint/sharepoint.service'
import { AuditLogSyncTask } from '../src/tasks/audit-log-sync.task'
...
describe('AuditLogSync Workflow (e2e)', () => {
  ...
  describe('Group 6: Deep Edge Cases', () => {
    ...
    it('EXT-06: Upsert Conflict - Idempotency for Existing ID', async () => {
      await auditLogRepo.save({
        id: 'raw_uri_conflict', // Matches the mock data generated by createMockActivity
      ...
      mockSharepointService.fetchActivityContent.mockResolvedValue([
        createMockActivity('uri_conflict'),
      ])
